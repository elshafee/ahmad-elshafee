...
const translations = {
  en: {
    ...
    "whyme.tag": "The Competitive Advantage",
    "whyme.title": "Why Choose Eng. Ahmad Elshafee?",
    "whyme.lead": "The unique engineering edge: full-spectrum capability from sensor hardware and embedded circuits to clinical-grade deep learning algorithms.",
    "whyme.r1Title": "Dual Hardware & AI Mastery",
    "whyme.r1Desc": "No need to hire separate electronics and machine learning teams. I bridge both worlds seamlessly—designing custom ESP32/PCB firmware, biomedical sensor circuits, and integrating them directly into clinical deep learning models.",
    "whyme.r1Highlight": "Unified hardware-to-cloud architecture with zero handoff friction",
    "whyme.r2Title": "Clinically & Competitively Validated",
    ...
    "whyme.r4Highlight": "Certified Google PM • Predictable sprints & reliable delivery",
    "whyme.r5Title": "Global Remote Ready & Fluent Communication",
    "whyme.r5Desc": "Fluent technical communication in English & Arabic. Extensive experience organizing international summits (Tunisia AI Hack, LEAP KSA) and collaborating with international engineering stakeholders.",
    "whyme.r5Highlight": "Seamless cross-timezone collaboration & clear documentation",
  ...
  ar: {
    ...
    "whyme.tag": "الميزة التنافسية والقيمة المضافة",
    "whyme.title": "لماذا تختار المهندس أحمد الشافعي؟",
    "whyme.lead": "الميزة الهندسية الفريدة: قدرة شاملة تبدأ من دوائر الحساسات والأنظمة المدمجة وصولاً لخوارزميات التعلم العميق السريرية.",
    "whyme.r1Title": "إتقان مزدوج للهاردوير والذكاء الاصطناعي",
    "whyme.r1Desc": "لا داعي لتوظيف فريقين منفصلين للإلكترونيات والبرمجة. أدمج العالمين معاً بسلاسة — من تصميم شرائح ESP32 ومستشعرات القياس الحيوي إلى دمجها مباشرة بنماذج التعلم العميق.",
    "whyme.r1Highlight": "معمارية هندسية موحدة من الدائرة إلى السحابة دون أي فجوات تسليم",
    "whyme.r2Title": "دقة معتمدة سريرياً وتكريم عالمي",
    "whyme.r2Desc": "نتائج واقعية تتجاوز النماذج النظرية. دقة تشخيصية تفوق 90% تم اختبارها سريرياً بروبوت Dr. HEMA وتكريم عالمي من Google ضمن أفضل 50 مشروعاً حول العالم.",
    "whyme.r2Highlight": "تحدي حلول جوجل (أفضل 50 عالمياً والمركز الثالث بالشرق الأوسط)",
    "whyme.r3Title": "انضباط قيادي وخبرة إدارة منشآت كبرى",
    "whyme.r3Desc": "خبرة إدارة مجمع مصانع بالخدمة العسكرية وشغل منصب نائب رئيس التطوير بمشروع هدهد الوطني بالسعودية تضمن أعلى معايير الجودة الصارمة وقابلية التوسع.",
    "whyme.r3Highlight": "إدارة العمليات الصناعية وتصميم معماريات الأنظمة عالية الكثافة",
    "whyme.r4Title": "إدارة مشاريع معتمدة من Google والتزام رشيق",
    "whyme.r4Desc": "حاصل على الاعتماد الاحترافي في إدارة المشاريع من Google، أطبق منهجيات Agile و Scrum لتحديد معالم واضحة وإدارة المخاطر دون أي تأخير أو مفاجآت.",
    "whyme.r4Highlight": "إدارة مشاريع معتمدة • تسليم متوقع في الموعد المحدد",
    "whyme.r5Title": "جاهزية للعمل الدولي عن بُعد وتواصل طلق",
    "whyme.r5Desc": "تواصل تقني احترافي باللغتين العربية والإنجليزية. خبرة واسعة في إدارة الفعاليات التكنولوجية الكبرى (Tunisia AI Hack ومؤتمر LEAP بالسعودية) والتنسيق الدولي.",
    "whyme.r5Highlight": "تعاون سلس عبر مختلف النطاقات الزمنية وتوثيق برمجي فائق الوضوح",
